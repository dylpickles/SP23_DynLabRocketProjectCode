...
Equations: 
Drag
F_drag = 0.5*C_d*A_rocket*R_air*(v_rocket^2)
...
Functions
calculateMass - calculate mass m_rocket throughout flight by solving for
momentum, rocket velocity calculated using stopwatch data and accelerometer
data
calculateVelocity - approximation for rocket velocity based on stopwatch
and acceleratometer data
